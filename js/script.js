...
const analize = () => {
	...
	if (userAnswer.Visitas == Answers.low && userAnswer.Azucarados == Answers.always && userAnswer.Cepilla == Answers.moderate && userAnswer.HiloDental == Answers.no)
		addDiagnostic({
			categoria: 'caries',
			diagnostico: enfermedades.cariesAdvertencia,
		});
	...
	if (userAnswer.Encias == Answers.moderate && userAnswer.CepillaSangre == Answers.si && userAnswer.MalAliento == Answers.si)
		addDiagnostic({
			categoria: 'gingivitis',
			diagnostico: enfermedades.gingivitis,
		});
	...
	if (userAnswer.MovilidadDental == Answers.si && userAnswer.Encias == Answers.high && userAnswer.Sarro == Answers.si && userAnswer.MalAliento == Answers.si)
		addDiagnostic({
			categoria: 'periodontitis',
			diagnostico: enfermedades.periodontitisAvanzada,
		});
